    ...
    public void atacar(Arena arena, Guerreiro adversario) {
        ...
        if (filaAcima != null) {
            ...
            if (guerreiroAcima != null) {
                ...
                System.out.println(this.getNome() + "(Manticora) também causou 15 de dano a " + guerreiroAcima.getNome() + " (fila acima).");
            }
        }
        ...
        if (filaAbaixo != null) {
            ...
            if (guerreiroAbaixo != null) {
                ...
                System.out.println(this.getNome() + "(Manticora) também causou 15 de dano a " + guerreiroAbaixo.getNome() + " (fila abaixo).");
            }
        }

        // Registrar o ataque principal
        System.out.println(this.getNome() + "(Manticora) atacou " + adversario.getNome() + " causando 30 de dano.");
    }
}
