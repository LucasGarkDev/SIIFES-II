...
//        arena.obterFila(1, 2).adicionarGuerreiro(new GuerreiroNordico("Tom tom", 30, 200));
//        arena.obterFila(1, 2).adicionarGuerreiro(new GuerreiroNordico("Bingulo", 30, 200));
        
     
        arena.obterFila(2, 1).adicionarGuerreiro(new Prometeano("Ralapin", 28, 75));
        //arena.obterFila(2, 1).adicionarGuerreiro(new Prometeano("Ralapin II", 28, 75));
